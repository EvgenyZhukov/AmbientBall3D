...
public class GameScript : MonoBehaviour
{
    #region Задачи
    /*      
     *      1. Настроить экран победы - разбить на два метода: 1. затенение экрана с появлением текста (предварительное присваивание значения тексту) 2. появление звезд (постепенное)
     *      добавить кнопку следующий уровень. настроить расположение текста
     *      
     *      Глобальные задачи
     ...
     *      9. Протестировать сохранение поворота камеры
     */
    #endregion
