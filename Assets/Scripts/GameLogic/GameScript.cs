...
public class GameScript : MonoBehaviour
{
    #region Задачи
    /*      
     *      1. Настроить экран победы 
     *      настроить затенение на половину и полное затенение с исчезновением текста(и звезд) после нажатия кнопки след.уровень, добавить запуск нового уровня при нажатии кнопки
     *      
     *      Глобальные задачи
