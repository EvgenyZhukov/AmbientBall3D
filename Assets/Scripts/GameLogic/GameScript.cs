...
public class GameScript : MonoBehaviour
{
    #region Задачи
    /*      
     *      1. Настроить экран победы - добавить кнопку следующий уровень. настроить расположение текста и звезд. 
     *      настроить затенение на половину и полное затенение с исчезновением текста после нажатия кнопки след.уровень
     *      
     *      Глобальные задачи
